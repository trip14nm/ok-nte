...
class HeistPathB(HeistPathA):
    ...
    def run_path(self):
        ...
        # self.lg1_wp4_buster()
        # 狗哥不下地问题没解决，暂时不推这个更新，只快几秒，想试验的自己删掉上面的 self.lg1_wp4() 和 self.lg1_wp5_avoid_combat_02()，取消 self.lg1_wp4_buster() 的注释
        self.wait_team_ui_settle()
    ...
    def goto_lg1_skip(self):
        ...
        self.sleep(0.10)
        self.send_key("d", down_time=1.98)
        self.sleep(0.10)
        self.send_key("s", down_time=0.10)
        self.sleep(0.10)
        self.send_key("s", down_time=0.10)
        ...
        self.sleep(0.85)
        self.send_key("d", down_time=0.42)
        self.sleep(0.52)
        self.send_key("d", down_time=0.36)
        self.sleep(1.00)
        self.send_key_up("w")
        self.sleep(0.30)
        self.switch_to_fighter(check_switched=True)  # 切到早雾控怪
    ...
    def lg1_wp4_buster(self):
        ...
        self.send_key_up("d")
        self.sleep(0.12)
        self.switch_to_avoider(check_switched=True) # 换狗哥
        self.send_key_down("w")
        self.sleep(5.20)
        self.send_key_down("lshift")
        self.sleep(2.60)
